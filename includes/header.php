...
<body>
    ...
    <!--End Preloader -->
    <!--Start Header-->
    <header class="ree-header fixed-top" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500">
        <div class="container m-p-l-r-0">
            <div class="menu-header horzontl">
                <div class="menu-logo">
                    <div class="dskt-logo">
                        <a class="nav-brand" href="./">
                            <img src="images/logo.png" alt="Logo" class="ree-logo" />
                        </a>
                    </div>
                </div>
                <div class="ree-nav" role="navigation">
                    <ul class="nav-list">
                                    ...
                                    <div class="container-fluid">
                                        <div class="menu-block-a">
                                            <div class="mega-menu-blocks">
                                                <h4>Transform your products into compelling visual storiesa and designs
                                                    with our expert product services.</h4>
                                                <a href="./contact.php" class="ree-btn ree-btn0 ree-btn-grdt2 mt30">
                                                    Contact Us <i class="fas fa-arrow-right fa-btn"></i></a>
                                            </div>
                                            <div class="mega-menu-blocks">
                                                <div class="menu-inner-block-a">
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">Avertising & Marketing</label>
                                                        </a>
                                                    ...
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">Small & Large Advertising
                                                                Video</label>
                                                        </a>
                                                        <ul class="menu-li-link">
                                                            <li><a href="./">Product Teasers</a></li>
                                                    ...
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">Colleteral Designing</label>
                                                        </a>
                                                        <ul class="menu-li-link">
                                                            <li><a href="./">Logo Design</a></li>
                                                            <li><a href="./">Brochture/ Catalogue</a></li>
                                                    ...
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">Product Photography</label>
                                                        </a>
                                                        <ul class="menu-li-link">
                                                            <li><a href="./">Detail Shots</a></li>
                                                            <li><a href="./">Product Variants</a></li>
                                                            <li><a href="./">Cut-Outs</a></li>
                                                            <li><a href="./">Packaging Shots</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">Product Video Creation</label>
                                                        </a>
                                                        <ul class="menu-li-link">
                                                            ...
                                                            <li><a href="./">Product Stories</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">Catalogue Product
                                                                Photography</label>
                                                        </a>
                                                        <ul class="menu-li-link">
                                                            <li><a href="./">Packaging Shots</a></li>
                                                            <li><a href="./">Group Shots</a></li>
                                                    ...
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">Social Media Adv.
                                                                Photography</label>
                                                        </a>
                                                        <ul class="menu-li-link">
                                                            <li><a href="./">Product Showcase Shots</a></li>
                                                            <li><a href="./">High-Impact Visuals</a></li>
                                                            <li><a href="./">Branded Content</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">Digital Marketing</label>
                                                        </a>
                                                        <ul class="menu-li-link">

                                                            <li><a href="./">SEO</a></li>
                                                            <li><a href="./">SMO/ SMM</a></li>
                                                            <li><a href="./">PPC / SEM</a></li>
                                                            <li><a href="./">Email/ Mobile Marketing</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="inner-blockss">
                                                        <a href="service_detail_page.php">
                                                            <label class="menu-headings">ECommerce Photography</label>
                                                        </a>
                                                        <ul class="menu-li-link">
                                                            <li><a href="./">Product Variants</a></li>
                                                            <li><a href="./">Cut-Outs Imaging</a></li>
                                                            <li><a href="./">Detail Shots</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                        ...
                        <li class="megamenu mega-small">
                            <a href="./product_detail_page.php" class="menu-links">Products</a>
                        </li>

                        <li class="megamenu mega-small">
                            <a href="./packaging_detail_page.php" class="menu-links">Packaging</a>
                        </li>
                ...
                <nav id="main-nav">
                    ...
                    <!-- <ul class="bottom-nav">
                        ...
                        <li class="ree-hc">
                            <a href="skype:JyotiArt.company" rel="noreferrer" target="_blank">
